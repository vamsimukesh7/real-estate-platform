...
const userSchema = new mongoose.Schema(
  {
    ...
    role: {
      type: String,
      enum: ['Buyer', 'Seller', 'Admin', 'Agent', 'User'],
      default: 'Buyer',
    },
    avatar: {
      url: String,
...
userSchema.methods.getDefaultPermissions = function() {
  const rolePermissions = {
    Buyer: ['read:property', 'send:messages'],
    Seller: ['create:property', 'read:property', 'update:property', 'send:messages', 'manage:bookings'],
  ...
  return rolePermissions[this.role] || rolePermissions.Buyer;
};
